function btn() {
    ...
    if (localStorageData == null) {
        ...
        if (editflow) {
            ...
            // let namecheck = storedData.findIndex(x => x.Name === PersonalInformation.Name);
            let emailcheck = storedData.findIndex(x => x.Email === PersonalInformation.Email);
            // let phonenumbercheck = storedData.findIndex(x => x.Phone === PersonalInformation.Phone);
            // let contactnamecheck = storedData.findIndex(x => x.Phone === PersonalInformation.Phone);
            let contactnumbercheck = storedData.findIndex(x => x.Phone === PersonalInformation.Phone);
            // let contactemailcheck = storedData.findIndex(x => x.Phone === PersonalInformation.Phone);
            if ( emailcheck === -1 && phonenumbercheck === -1) {
                storedData.push(PersonalInformation)
            } else {
